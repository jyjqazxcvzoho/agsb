...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "jyj333"         # 用户名
UUID = "35b0d353-fdd2-40cd-a772-823476bc2711"                     # UUID，留空则自动生成
PORT = 38112                   # Vmess端口，留空或0则自动生成
DOMAIN = "free.jyjqazxcv.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMGNlMjY1MzgwNTU4ZjBlZWVhMzZjNTkwMDFiYjliNGYiLCJ0IjoiZDJjY2JmYmMtNjcxYS00ZDljLTk4ZTAtNjZjNjIyMDA4MzViIiwicyI6IllXTTRNVEF3WkRZdE9XWTBNaTAwTURWaExUZ3paRFl0Wm1ZNFkyWTVOMk16WldabCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
